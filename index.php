                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$jumlah;?></td>
                                            <td>
                                                <a href="view.php?idp=<?=$idpesanan;?>" class="btn btn-primary">Tampilkan</a> 
                                                <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#delete<?=$idpesanan;?>">
                                                    Delete
                                                </button> 
                                            </td>
                                        </tr>
                                                    <!-- Modal Hapus Data Pesanan -->
                                        <div class="modal fade" id="delete<?=$idpesanan;?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Hapus data pesanan <?=$idpesanan;?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        <form method="post">
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                                Apakah Anda yakin akan menghapus data pesanan ini?
                    ...
                    <div class="modal-body">
                        ...
                        <select name="idpelanggan" class="form-control">
                            ...
                            while ($pl = mysqli_fetch_array($getpelanggan)) {
                                ...
                                $alamat = $pl["alamat"];
                                echo "<option value='$idpelanggan'>$namapelanggan - $alamat</option>";
                            }
                            ?>
                        </select>
                    </div>
